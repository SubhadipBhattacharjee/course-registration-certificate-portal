              ...
              <form role="form" action="<?php  base_url('admin/branch-office/update-branch') ?>/<?php echo $value->id; ?>" method="POST" id="main-office" 
                ...
                <div class="card-body">
                  ...
                  <!-- <div class="form-group">
                     ...
                     <a href="<?php echo base_url('partner/students/dob'); ?>/<?php echo $value->id; ?>" target="_blank">Click Here</a>
                  </div>

                  <div class="form-group">
                     <label for="author">18.View Educational Documents:-</label>
                     <a href="<?php echo base_url('partner/students/documents'); ?>/<?php echo $value->id; ?>" target="_blank">Click Here</a>
                  </div> -->

                  <div class="form-group">
                     <label for="author">17.Download Proof of DOB:-</label>
                     <a href="<?php echo base_url(''); ?>/<?php echo $value->dob_proof; ?>" download>Click to Download</a>
                  </div>

                  <div class="form-group">
                     <label for="author">18.Download Educational Documents:-</label>
