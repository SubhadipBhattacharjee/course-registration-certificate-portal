        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form role="form" action="<?php echo base_url('partner/enrolled-students/save-records') ?>" method="POST" id="student-registration" 
                ...
                <div class="form-group">
                     ...
                     <input type="text" class="form-control" name="centre_name" value="<?php echo $rows->name; ?>" readonly>
                  </div>

                  <div class="form-group">
                     <label for="author">2.Study Centre Code:-</label>
                     <input type="number" class="form-control" name="code"  value="<?php echo $rows->code; ?>" readonly>
                  </div>
