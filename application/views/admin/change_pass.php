...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg"><b><i>Change Your Password</i></b></p>

      <form action="<?php echo base_url('admin/login/change_pass');?>" method="post" id="change-pass">
        <div class="input-group mb-3">
          <input type="password" name="c_pass" class="form-control" placeholder="Current Password">
...
<script>
            ...
            <?php if($this->session->flashdata('error-pass')){  ?> 
            Command: toastr["error"]("<i><?php echo $this->session->flashdata('error-pass'); ?></i>")
            <?php } ?>

            <?php if($this->session->flashdata('error-new-pass')){  ?> 
            Command: toastr["error"]("<i><?php echo $this->session->flashdata('error-new-pass'); ?></i>")
            <?php } ?>

            <?php if($this->session->flashdata('success')){  ?> 
            Command: toastr["success"]("<i><?php echo $this->session->flashdata('success'); ?></i>")
            <?php } ?>
