...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg"><b><i>Sign In to the Admin Panel</i></b></p>

      <form action="<?php echo base_url('admin/login/check');?>" method="POST" id="admin-login-form" >
