          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Branch Office Address</h3>
              </div>
              <!-- /.card-header -->

              <!-- form start -->
              <form role="form" action="<?php echo base_url('admin/stream/save-stream'); ?>" method="POST" id="form" 
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                     <label for="author">1.Name of the Branch:-</label>
                  ...
                  <div class="">
                    <label for="author">2.Write down Short Description:-</label>
                       ...
                       <div class="mb-3">
                         <textarea class="textarea" name="desc" rows="3" cols="160"></textarea>  
                       </div>
...
<script>
  $(function () {
   ...
   <script>
            ...
            <?php if($this->session->flashdata('save-stream')){  ?> 
            Command: toastr["success"]("<i><?php echo $this->session->flashdata('save-stream'); ?></i>")
            <?php } ?>
