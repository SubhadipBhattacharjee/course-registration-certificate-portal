        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <?php if($value){ ?>
              <!-- form start -->
              <form role="form" action="<?php echo base_url('admin/course/update-course') ?>/<?php echo $value->id; ?>" method="POST" id="main-office" 
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                     ...
                     <input type="number" class="form-control" name="fees" placeholder="Course Name..." value="<?php echo $value->fees;?>">
                  </div>
                  ...
                  <div class="form-group">
                     ...
                     <input type="number" class="form-control" name="code" placeholder="Course Code..." value="<?php echo $value->code; ?>">
                  </div>
...
<script>
  $(function () {
   ...
   <script>
            ...
            <?php if($this->session->flashdata('update-course')){  ?> 
            Command: toastr["success"]("<i><?php echo $this->session->flashdata('update-course'); ?></i>")
            <?php } ?>
