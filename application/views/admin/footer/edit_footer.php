        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <?php if($value){ ?>
              <!-- form start -->
              <form role="form" action="<?php  echo base_url('admin/footer-section/update'); ?>/<?php echo $value->id; ?>" method="POST" id="footer" 
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                     <label for="author">9.Social Media Link for WhatsApp:-</label>
                     <input type="text" class="form-control" name="whatsapp" placeholder="this Pattern (https://www.abc.com)" value="<?php echo $value->whatsapp; ?>">
                  </div>
...
<script>
  $(function () {
   ...
   <script>
            ...
            <?php if($this->session->flashdata('update-footer')){  ?> 
            Command: toastr["success"]("<i><?php echo $this->session->flashdata('update-footer'); ?></i>")
            <?php } ?>
