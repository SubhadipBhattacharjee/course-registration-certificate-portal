          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Banner Section of Home Page</h3>
              </div>
              <!-- /.card-header -->

              <!-- form start -->
              <form role="form" action="<?php echo base_url('admin/home/save_banner') ?>" method="POST" id="form" 
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                     <label >2.Select Banner Image :-</label><br>
...
<script>
  $(function () {
   ...
   <script>
            ...
            <?php if($this->session->flashdata('save-banner')){  ?> 
               Command: toastr["success"]("<i><?php echo $this->session->flashdata('save-banner'); ?></i>")
            <?php } ?>
