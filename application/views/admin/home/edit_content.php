          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit Home Page Content</h3>
              </div>
              <!-- /.card-header -->

              <?php if($value){ ?>
              <!-- form start -->
              <form role="form" action="<?php echo base_url('admin/home-content/update') ?>/<?php echo $value->id; ?>" method="POST" id="main-office" 
                ...
                <div class="card-body">
                  ...
                  <div class="">
                    <label for="author">1.Welcome message to the Students:-</label>
                     
                       <div class="mb-3">
                         <textarea class="textarea" name="w_desc" rows="3" cols="160"><?php echo $value->gen_desc; ?></textarea>  
                       </div>
                  </div>

                  <div class="">
                    <label for="author">2.Chairman message :-</label>
                     
                       <div class="mb-3">
                         <textarea class="textarea" name="chair_desc" rows="3" cols="160"><?php echo $value->chairman_desc; ?></textarea>  
                       </div>
                  </div>
