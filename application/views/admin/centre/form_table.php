        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form role="form" action="<?php echo base_url('admin/franchise-table-content/save-table') ?>" method="POST" id="branch-office" 
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="cars">1. Select Category:-</label><br>

                    <select name="status" id="" class="custom-select">
                    <option value="">Select Category</option>  
                      <option value="centre">Kits Provided to Authorized Training Centre</option>        
                      <option value="students">Kits Provided to registered Students</option>
                      <option value="franchise">Requirment for getting The Franchise</option>     
                    </select> 
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" name="details" placeholder="Institue Name...">
                  </div>
                  ...
                  <!-- <div class="form-group">
                     <label for="author">2.<b> Generate Franchise Code</b> :-</label>&nbsp <button onclick="gfg();">Click Here</button><br>
                      
                     <input type="text" class="form-control" name="code" placeholder="Franchise Code..." id="code">
