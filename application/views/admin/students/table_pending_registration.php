 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h6>*Click on the <b><i>Pending Status</i></b> to approve <b>Student's Registration</b></h6>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-header">
                <h3 class="">Students Pending Registration</h3>
                    ...
                    <tr>
                      ...
                      <td>
                          ...
                          <?php }elseif($val->pay_status=='0'){ ?>
                            <a href="<?php echo base_url('admin/students/approve_registration') ?>/<?php echo $val->id; ?>">
