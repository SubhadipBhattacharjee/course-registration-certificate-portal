          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit General Details</h3>
              </div>
              <!-- /.card-header -->

              <?php if($value){ ?>
              <!-- form start -->
              <form role="form" action="<?php  echo base_url('admin/general-details/update'); ?>/<?php echo $value->id; ?>" method="POST" id="footer" 
                ...
                <div class="card-body">
                  ...
                  <div class="">
                    <label for="author">3.Write down Short Description:-</label>
                       ...
                       <div class="mb-3">
                         <textarea class="textarea" name="desc" rows="3" cols="160"><?php echo $value->description; ?></textarea> <!-- class="textarea" -->
                       </div>
